...
class Test_Validate_Main_Block(unittest.TestCase):
    ...
    def test_all_good(self):
        ...
        definition = yaml.load( open('input/' + files_name + '.def.yml') )
        config = yaml.load( open('input/' + files_name + '.yml') )
    ...
    def test_unvalid_type_str(self):
        ...
        definition = yaml.load( open('input/' + files_name + '_str.def.yml') )
        config = yaml.load( open('input/' + files_name + '.yml') )
    ...
    def test_unvalid_type_list(self):
        files_name = '03_unvalid_type'
        definition = yaml.load( open('input/' + files_name + '_list.def.yml') )
        config = yaml.load( open('input/' + files_name + '.yml') )
    ...
    def test_unvalid_type_dict(self):
        files_name = '03_unvalid_type'
        definition = yaml.load( open('input/' + files_name + '_dict.def.yml') )
        config = yaml.load( open('input/' + files_name + '.yml') )
    ...
    def test_unvalid_type_int(self):
        files_name = '03_unvalid_type'
        definition = yaml.load( open('input/' + files_name + '_int.def.yml') )
        config = yaml.load( open('input/' + files_name + '.yml') )
